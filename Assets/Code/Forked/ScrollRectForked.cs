...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/Scroll Rect Forked", 37), DisallowMultipleComponent, ExecuteInEditMode, RequireComponent(typeof(RectTransform)), SelectionBase]
    public class ScrollRectForked : UIBehaviour, IEventSystemHandler, IBeginDragHandler, IInitializePotentialDragHandler, IDragHandler, IEndDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutController, ILayoutGroup
    {
        /// <summary>
